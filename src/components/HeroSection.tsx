  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 py-20 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto">
        ...
        >
          <img src={sbMcetLogo} alt="IEEE SB MCET" className="h-12 md:h-16 object-contain" />
          <img src={offensoLogo} alt="Offenso Hackers Academy" className="h-10 md:h-14 object-contain" />
          <img src={ieeeLogo} alt="IEEE" className="h-10 md:h-14 object-contain" />
        </motion.div>
